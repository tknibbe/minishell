...
It is the first group project in the 42 core curriculum. <b>([tknibbe](https://github.com/tknibbe) && [cristje21](https://github.com/cristje21))</b>
...
```
git clone https://github.com/tknibbe/minishell.git minishell
```
```
cd minishell
```

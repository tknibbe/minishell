...
/*   Updated: 2023/10/18 15:54:56 by tknibbe          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*The unset_echo function is used to modify the terminal settings to disable the ECHOCTL flag. This flag, when disabled, causes the terminal to hide control characters. The function retrieves the current terminal attributes using tcgetattr, disables ECHOCTL in the c_lflag field, and then sets the modified attributes using tcsetattr.
